...
@section('content')
    ...
    <section class="container-fluid" id="skl-div">
        <div id="h-div" class="position-absolute text-light font-weight-bolder text-right">
            <header>
                <h1>
                    <span class="h1_titles">Finding the Best GCE A Level Schools in Singapore</span><br>
                </h1>
            </header>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12 align-self-center order-1">
                        <ul class="breadcrumb d-block">
                            ...
                            <li class="active">GCE A Level Schools in Singapore</li>
                        </ul>
                    </div>
                </div>
            </div>
...
@section('local-assets')
    ...
    <link rel="stylesheet" href="{{ custom_asset('vendor/rs-plugin/css/settings.css') }}">
    <link rel="stylesheet" href="{{ custom_asset('vendor/rs-plugin/css/layers.css') }}">
    <link rel="stylesheet" href="{{ custom_asset('vendor/rs-plugin/css/navigation.css') }}">
...
@section('local-scripts')
    ...
    <link rel="stylesheet" href="{{ custom_asset('vendor/isotope/jquery.isotope.min.js') }}"/>
    <script src="{{ custom_asset('vendor/rs-plugin/js/jquery.themepunch.tools.min.js') }}"></script>
    <script src="{{ custom_asset('vendor/rs-plugin/js/jquery.themepunch.revolution.min.js') }}"></script>
    <script src="{{ custom_asset('js/views/view.contact.js') }}"></script>
