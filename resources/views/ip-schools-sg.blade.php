...
@section('content')
    ...
    <section class="container-fluid" id="skl-div">
        <div id="h-div" class="position-absolute text-light font-weight-bolder text-right">
            <header>
                <h1>
                    <span class="h1_titles">Integrated Programme (IP) Schools in Singapore</span><br>
                </h1>
            </header>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12 align-self-center order-1">
                        <ul class="breadcrumb d-block">
                            ...
                            <li class="active">Integrated Programme (IP) Schools in Singapore</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row s-countries">
                            <div class="col-xl-4 col-md-12">
                                <div class="outer-box mx-auto my-2">
                                    <div class="content-b-desc" style="background: url({{ $imageUrlBase }}school/MasXuQAnDdJHZ3bk-primary.webp); background-size: cover; background-position: center center;" alt="Tanglin Trust School Singapore">
                            ...
                            <div class="col-xl-4 col-md-12">
                                <div class="outer-box mx-auto my-2">
                                    <div class="content-b-desc" style="background: url({{ $imageUrlBase }}school/Jk4n1dRGVQHFE1cL-primary.webp); background-size: cover; background-position: center center;" alt="Tanglin Trust School">
                                        <div class="content-wrap">
                                            <div class="sub-content-wrap">
                            ...
                            <div class="col-xl-4 col-md-12">
                                <div class="outer-box mx-auto my-2">
                                    <div class="content-b-desc" style="background: url({{ $imageUrlBase }}school/UpQDLmTyS9smppFC-primary.webp); background-size: cover; background-position: center center;" alt="Insworld Institute">
                                        <div class="content-wrap">
                                            <div class="sub-content-wrap">
...
@section('local-assets')
    ...
    <link rel="canonical" href="https://itseducation.asia/school/singapore/ip-schools-sg" />
