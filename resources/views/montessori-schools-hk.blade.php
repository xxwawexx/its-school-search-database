...
@section('content')
    ...
    <section class="container-fluid" id="skl-div">
        <div id="h-div" class="position-absolute text-light font-weight-bolder text-right">
            <header>
                <h1>
                    <span class="h1_titles">Finding the Best Montessori Schools in Hong Kong</span><br>
                    <span class="h1_titles">Montessori Schools in Hong Kong</span><br>
                </h1>
            </header>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12 align-self-center order-1">
                        <ul class="breadcrumb d-block">
                            <li>
                            @if( url()->current() == "https://school.itseducation.asia/hong-kong/montessori-schools-hk")
                            ...
                            <li class="active">Montessori Schools In Hong Kong</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <p>
                        ...
                        <ul>
                            <li>Woodland Pre-Schools</li>
                            <li>Guidepost Montessori</li>
                            <li>Discovery Montessori School</li>
                            <li>International Montessori School</li>
                            <li>Infinity Montessori</li>
                            <li>Little Lantau Montessori Kindergarten</li>
                            <li>Sai Kung Montessori</li>
                            <li>Oatktree Montessori</li>
                        </ul>
                    </p>
