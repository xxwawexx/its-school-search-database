...
@section('content')
    ...
    <section class="container-fluid" id="skl-div">
        <div id="h-div" class="position-absolute text-light font-weight-bolder text-right">
            <header>
                <h1>
                    <span class="h1_titles">Finding the Best Primary Schools in Singapore</span><br>
                </h1>
            </header>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12 align-self-center order-1">
                        <ul class="breadcrumb d-block">
                            <li>
                            @if( url()->current() == "https://school.itseducation.asia/singapore/primary-schools-sg")
                            ...
                            <li class="active">Primary Schools in Singapore</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-9">
                    ...
                    <p>
                        <strong>
                            ...
                            Nexus International School (Singapore) <br>
                            Stamford American School  <br>
                    ...
                    <section>
                        <div class="row s-countries">
                                ...
                                <div class="outer-box mx-auto my-2">
                                    <div class="content-b-desc" style="background: url(https://itseducation.asia/school/img/school/pzWpnv9f6V3vUBW2-primary.jpg); background-size: cover; background-position: center center;" alt="Hollandse School Limited">
                                        <div class="content-wrap">
                                            ...
                                            @if( url()->current() == "https://school.itseducation.asia/hong-kong/primary-schools-sg")
                            ...
                            <div class="col-xl-4 col-md-12">
                                <div class="outer-box mx-auto my-2">
                                    <div class="content-b-desc" style="background: url(https://itseducation.asia/school/img/school/mOpaS2HavOZfbC8L-primary.jpg); background-size: cover; background-position: center center;" alt="Brighton College Singapore">
                                        <div class="content-wrap">
                                            <div class="sub-content-wrap">
                                            @if( url()->current() == "https://school.itseducation.asia/hong-kong/primary-schools-sg")
                                                <p class="text-center m-1"><a href="https://school.itseducation.asia/school-profile/Brighton+College+Singapore" class="btn btn-primary s-btn">Brighton College Singapore</a></p>
                                            @else
                                                <p class="text-center m-1"><a href="https://itseducation.asia/school/school-profile/Brighton+College+Singapore" class="btn btn-primary s-btn">Brighton College Singapore</a></p>
                                            @endif
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-4 col-md-12">
                                <div class="outer-box mx-auto my-2">
                                    <div class="content-b-desc" style="background: url(https://itseducation.asia/school/img/school/5P5W5GihyGvkwzBV-primary.jpg); background-size: cover; background-position: center center;" alt="Etonhouse International School - Orchard Campus">
                                        <div class="content-wrap">
                                            <div class="sub-content-wrap">
                                            @if( url()->current() == "https://school.itseducation.asia/hong-kong/primary-schools-sg")
                                                <p class="text-center m-1"><a href="https://itseducation.asia/school/school-profile/Etonhouse+International+School+-+Orchard+Campus" class="btn btn-primary s-btn">Etonhouse International School - Orchard Campus</a></p>
                                            @else
                                                <p class="text-center m-1"><a href="https://itseducation.asia/school/school-profile/Etonhouse+International+School+-+Orchard+Campus" class="btn btn-primary s-btn">Etonhouse International School - Orchard Campus</a></p>
                                            @endif
                                            </div>
                            ...
                            <div class="col-xl-4 col-md-12">
                                <div class="outer-box mx-auto my-2">
                                    <div class="content-b-desc" style="background: url(https://itseducation.asia/school/img/school/CIsWMTxi0Zv5O5S8-primary.jpg); background-size: cover; background-position: center center;" alt="The Perse School Singapore">
                                        <div class="content-wrap">
                                            <div class="sub-content-wrap">
                                            @if( url()->current() == "https://school.itseducation.asia/hong-kong/primary-schools-sg")
                                                <p class="text-center m-1"><a href="https://school.itseducation.asia/school-profile/The+Perse+School+Singapore" class="btn btn-primary s-btn">The Perse School Singapore</a></p>
                                            @else
                                                <p class="text-center m-1"><a href="https://itseducation.asia/school/school-profile/The+Perse+School+Singapore" class="btn btn-primary s-btn">The Perse School Singapore</a></p>
                                            @endif
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-4 col-md-12">
                                <div class="outer-box mx-auto my-2">
                                    <div class="content-b-desc" style="background: url(https://itseducation.asia/school/img/school/yj9nL6HVqUiDFdGo-primary.jpg); background-size: cover; background-position: center center;" alt="Razum International School">
                                        <div class="content-wrap">
                                            <div class="sub-content-wrap">
                                            @if( url()->current() == "https://school.itseducation.asia/hong-kong/primary-schools-sg")
                                                <p class="text-center m-1"><a href="https://school.itseducation.asia/school-profile/Razum+International+School" class="btn btn-primary s-btn">Razum International School</a></p>
                                            @else
                                                <p class="text-center m-1"><a href="https://itseducation.asia/school/school-profile/Razum+International+School" class="btn btn-primary s-btn">Razum International School</a></p>
                                            @endif
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-4 col-md-12">
                                <div class="outer-box mx-auto my-2">
                                    <div class="content-b-desc" style="background: url(https://itseducation.asia/school/img/school/TecKru0GTlwRsQ7D-primary.jpg); background-size: cover; background-position: center center;" alt="Etonhouse International School - Broadrick Campus">
                                        <div class="content-wrap">
                                            <div class="sub-content-wrap">
                                            @if( url()->current() == "https://school.itseducation.asia/hong-kong/primary-schools-sg")
                                                <p class="text-center m-1"><a href="https://school.itseducation.asia/school-profile/Etonhouse+International+School+-+Broadrick+Campus" class="btn btn-primary s-btn">Etonhouse International School - Broadrick Campus</a></p>
                                            @else
                                                <p class="text-center m-1"><a href="https://itseducation.asia/school/school-profile/Etonhouse+International+School+-+Broadrick+Campus" class="btn btn-primary s-btn">Etonhouse International School - Broadrick Campus</a></p>
                                            @endif
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-4 col-md-12">
                                <div class="outer-box mx-auto my-2">
                                    <div class="content-b-desc" style="background: url(https://itseducation.asia/school/img/school/9aUzj2h5mQ2zbvUt-primary.jpg); background-size: cover; background-position: center center;" alt="The Grange Institution">
                                        <div class="content-wrap">
                                            <div class="sub-content-wrap">
                                            @if( url()->current() == "https://school.itseducation.asia/hong-kong/primary-schools-sg")
                                                <p class="text-center m-1"><a href="https://school.itseducation.asia/school-profile/The+Grange+Institution" class="btn btn-primary s-btn">The Grange Institution</a></p>
                                            @else
                                                <p class="text-center m-1"><a href="https://itseducation.asia/school/school-profile/The+Grange+Institution" class="btn btn-primary s-btn">The Grange Institution</a></p>
                                            @endif
                                            </div>
                                        </div>
                                    </div>
