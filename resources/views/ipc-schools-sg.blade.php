...
@section('content')
    ...
    <section class="container-fluid" id="skl-div">
        <div id="h-div" class="position-absolute text-light font-weight-bolder text-right">
            <header>
                <h1>
                    <span class="h1_titles">International Primary Curriculum (IPC) Schools in Singapore</span><br>
                </h1>
            </header>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12 align-self-center order-1">
                        <ul class="breadcrumb d-block">
                            <li>
                            @if( url()->current() == "https://school.itseducation.asia/singapore/international-schools-sg/ipc-schools-sg")
                            ...
                            <li class="active">International Primary Curriculum (IPC) Schools in Singapore</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container container-lg py-5">
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <h2>
                        List of Top IPC Schools in Singapore
                    </h2>
                    ...
                    <h2>
                        Criteria for Choosing the IPC Schools in Singapore
                    </h2>
