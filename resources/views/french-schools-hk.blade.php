...
@section('content')
    ...
    <section class="container-fluid" id="skl-div">
        <div id="h-div" class="position-absolute text-light font-weight-bolder text-right">
            <header>
                <h1>
                    <span class="h1_titles">Finding the Best French International Schools in Hong Kong</span><br>
                </h1>
            </header>
        </div>
    ...
    <section>
        <div class="container container-lg py-5">
            <div class="row">
                <div class="col-lg-9">
                    <p>
                        Are you relocating to Hong Kong and would like your child to study at a French school? Or do you want them to learn French in a bilingual learning community? There are some excellent options.
                    </p>

                    <p>
                        The French International School in Hong Kong (FIS) is the largest and most popular. There are four campuses around Hong Kong Island. FIS opened in 1963 as one of the first international schools. It is now one of Hong Kong’s most prominent international through-train schools. FIS offers education from Nursery up to Sixth Form (3 to 18 years old).
                    </p>

                    <p>
                        There are two streams offered: the International stream and the French stream. The campus each student is based at depends on their stream and year group, as well as on the availability of free places.
                    </p>

                    <h2>
                        List of Top French International Schools in Hong Kong
                    </h2>
                    ...
                    <p>
                        <h4>Lou Pichoun</h4>
                        - A private school that follows the French National Curriculum. <br>
                        - Located in Tseung Kwan O and Stanley. An accredited AEFE school (Agency for French Education Abroad) supervised by the French Ministry of Foreign Affairs. Lou Pichoun offers playgroups for 13 to 24 months in French, English or Mandarin. After-school programmes are also available for children between 2 and 6 years old, and during school holidays, Lou Pichoun offers camps in English, French and Mandarin.
                    </p>

                    <p>
                        <strong>- Les Petits Lascars French International Preschool</strong>: The school opened in 2006. It offers preschool education and the French National Curriculum. Students from 9 months to 6 years old learn English, French and Mandarin. AEFE accredits the school. Les Petits Lascars and the Hong Kong Kids Academy operate two Central and Tseung Kwan O schools.
                    </p>

                    <h2>
                        Criteria for Choosing a French International School in Hong Kong
                    </h2>
...
@section('local-assets')
    ...
    <link rel="canonical" href="https://itseducation.asia/school/hong-kong/international-schools-hk/french-schools-hk" />
