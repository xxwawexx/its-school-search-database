...
@section('content')
    ...
    <section class="container-fluid" id="skl-div">
        <div id="h-div" class="position-absolute text-light font-weight-bolder text-right">
            <header>
                <h1>
                    <span class="h1_titles">Finding the Best International Schools in Singapore</span><br>
                </h1>
            </header>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12 align-self-center order-1">
                        <ul class="breadcrumb d-block">
                            <li>
                            @if( url()->current() == "https://school.itseducation.asia/singapore/international-schools-sg")
                            ...
                            <li class="active">International Schools in Singapore</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-9">
                    ...
                    <section>
                        <div class="row s-countries">
                                ...
                                <div class="outer-box mx-auto my-2">
                                    <div class="content-b-desc" style="background: url(https://itseducation.asia/school/img/school/TecKru0GTlwRsQ7D-primary.jpg); background-size: cover; background-position: center center;" alt="Etonhouse International School - Broadrick Campus">
                                        <div class="content-wrap">
                                            ...
                                            @if( url()->current() == "https://school.itseducation.asia/hong-kong/international-schools-sg")
                            ...
                            <div class="col-xl-4 col-md-12">
                                <div class="outer-box mx-auto my-2">
                                    <div class="content-b-desc" style="background: url(https://school.itseducation.asia/img/school/5P5W5GihyGvkwzBV-primary.jpg); background-size: cover; background-position: center center;" alt="Etonhouse International School - Orchard Campus">
                                        <div class="content-wrap">
                                            <div class="sub-content-wrap">
                                            @if( url()->current() == "https://school.itseducation.asia/hong-kong/international-schools-sg")
                                                <p class="text-center m-1"><a href="https://school.itseducation.asia/school-profile/Etonhouse+International+School+-+Orchard+Campus" class="btn btn-primary s-btn">Etonhouse International School - Orchard Campus</a></p>
                                            @else
...
@section('local-assets')
    ...
    <link rel="canonical" href="https://itseducation.asia/school/singapore/international-schools-sg" />
