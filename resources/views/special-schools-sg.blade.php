...
@section('content')
    ...
    <section class="container-fluid" id="skl-div">
        <div id="h-div" class="position-absolute text-light font-weight-bolder text-right">
            <header>
                <h1>
                    <span class="h1_titles">Finding the Special Needs Schools in Singapore</span><br>
                </h1>
            </header>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12 align-self-center order-1">
                        <ul class="breadcrumb d-block">
                            <li>
                            @if( url()->current() == "https://school.itseducation.asia/singapore/special-schools-sg")
                            ...
                            <li class="active">Special Schools in Singapore</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <p>
                        <strong>
                            Pathlight School <br>
                            Andrew's Mission School <br>
                            Chaoyang SchoolTanglin School <br>
                            AWWA School @ Bedok <br>
                            MINDS – Towner Gardens School <br>
                            Eden School <br>
                            Delta Senior School <br>
                            Grace Orchard School <br>
                            AWWA School @ Napiri <br>
                            Maitri School <br>
                            MINDS <br>
                            Rainbow Centre <br>
                            Metta School <br>
                            ...
                            Grace Orchard School <br>
                            Metta School <br>
                            Cerebral Palsy Alliance Singapore School <br>
                            Canossian School
                        </strong>
                    </p>
                    ...
                    <p>
                        Here is the list:
                        <ol>
                            <li>International French School (Singapore)</li>
                            <li>The Winstedt School </li>
                            <li>Dover Court International School </li>
                            <li>ISS International School </li>
                            <li>The GUILD International School </li>
                            <li>Integrated International School </li>
                            <li>Canadian International School </li>
                            <li>Nexus International School (Singapore)</li>
                            <li>Bright Path </li>
                            <li>Tanglin Trust School </li>
                            <li>Australian International School </li>
                            <li>EtonHouse International School and Preschool </li>
                            <li>Stamford American International School </li>
                            <li>Blue House International </li>
...
@section('local-assets')
    ...
    <link rel="canonical" href="https://itseducation.asia/school/singapore/special-schools-sg" />
