...
@section('content')
    ...
    <section class="container-fluid" id="skl-div">
        <div id="h-div" class="position-absolute text-light font-weight-bolder text-right">
            <header>
                <h1>
                    <span class="h1_titles">Finding the Best Independent Schools in Hong Kong</span><br>
                </h1>
            </header>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12 align-self-center order-1">
                        <ul class="breadcrumb d-block">
                            <li>
                            @if( url()->current() == "https://school.itseducation.asia/hong-kong/independent-schools-hk")
                            ...
                            <li class="active">Independent Schools in Hong Kong</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <p>
                        ...
                        <ol>
                            <li>ESF Renaissance College</li>
                            <li>ESF Discovery College</li>
                            <li>Independent Schools Foundation Academy</li>
                            <li>Victoria Shanghai Academy</li>
                            <li>PLK Choi Kai Yau</li>
...
@section('local-assets')
    ...
    <link rel="canonical" href="https://itseducation.asia/school/hong-kong/independent-schools-hk" />
