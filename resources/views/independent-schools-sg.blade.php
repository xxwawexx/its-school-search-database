...
@section('content')
    ...
    <section class="container-fluid" id="skl-div">
        <div id="h-div" class="position-absolute text-light font-weight-bolder text-right">
            <header>
                <h1>
                    <span class="h1_titles">Finding the Best Independent Schools in Singapore</span><br>
                </h1>
            </header>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12 align-self-center order-1">
                        <ul class="breadcrumb d-block">
                            <li>
                            @if( url()->current() == "https://school.itseducation.asia/singapore/independent-schools-sg")
                            ...
                            <li class="active">Independent Schools in Singapore</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container container-lg py-5">
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <p>
                        Here is the list of Independent Schools in Singapore <br>
                        <ol>
                            <li>Anglo-Chinese School (Independent)</li>
                            <li>Hwa Chong Institution (Secondary)</li>
                            <li>Methodist Girls' School (Secondary)</li>
                            <li>Nanyang Girls' High School.</li>
                            <li>Raffles Girls' School (Secondary)</li>
                            <li>Raffles Institution (Secondary)</li>
                            <li>Singapore Chinese Girls' School.</li>
                            <li>St. Joseph's Institution (Secondary)</li>
                        </ol>
                    </p>

                    <p>
                        Independent schools are granted autonomy, and other government schools are subjected to MOE's syllabus. The independent schools receive lesson government funding but must adhere to government policies and regulations regarding teacher qualifications, examinations and school operations. The independent schools generally charge much higher fees. The facilities are much better, and they are highly selective. The schools offer a 6-year curriculum culminating in the Singapore-Cambridge General Certificate in Education (GCE), Advanced Level Examination. St Joseph's Institution is one of few IB Schools under the umbrella of  Singapore Independent schools.  These schools are recognised as some of the best in the world, and Singapore has one of the best education systems. Students rank among the top achievers in examinations. And achieve stellar results in mathematics and science subjects and competitions.
                    </p>

                    <h2>
                        Criteria for Choosing a Independent School in Singapore
                    </h2>
                    ...
                    <p>
                        Lastly, a school’s environment is essential as your child will spend most of their daily life at the school. It would be beneficial for your child if the school offers a sense of belonging. The secondary school years are tough and as a child develops, their needs will be different and require strong support within the school.
                    </p>
                                ...
                                <div class="outer-box mx-auto my-2">
                                    <div class="content-b-desc" style="background: url(https://itseducation.asia/school/img/school/0rZjeBM5VfjN8I3F-primary.jpg); background-size: cover; background-position: center center;" alt="St Joseph's Institution International">
                                        <div class="content-wrap">
                                            <div class="sub-content-wrap">
                                            @if( url()->current() == "https://school.itseducation.asia/singapore/independent-schools-sg")
                                                <p class="text-center m-1"><a href="https://itseducation.asia/school/school-profile/Independent+Schools+Foundation+-+Academy" class="btn btn-primary s-btn">St Joseph's Institution International</a></p>
                                            @else
                                                <p class="text-center m-1"><a href="https://itseducation.asia/school/school-profile/Independent+Schools+Foundation+-+Academy" class="btn btn-primary s-btn">St Joseph's Institution International</a></p>
                                            @endif
                                            </div>
