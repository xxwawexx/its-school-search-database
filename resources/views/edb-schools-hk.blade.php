...
@section('content')
    ...
    <section class="container-fluid" id="skl-div">
        <div id="h-div" class="position-absolute text-light font-weight-bolder text-right">
            <header>
                <h1>
                    <span class="h1_titles">Finding the Best Education Bureau Schools in Hong Kong</span><br>
                </h1>
            </header>
        </div>
        ...
        <div class="container container-lg py-5">
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <p>
                        There is an extensive list of <strong>EDB schools in Hong Kong</strong>: The types of schools are <br>
                        - Local schools, which are run and funded by the government <br>
                        - Aided Public schools – run by charitable or religious organisations <br>
                    ...
                    <p>
                        Some of the school choices include: <br>
                        - English Schools Foundation <br>
                        - Canadian International School <br>
                        - Chinese International School <br>
                        - Discovery Bay International School <br>
                        - French International School <br>
                        - German Swiss International School <br>
                        - Hong Kong International Schol <br>
                        - Hong Kong Academy <br>
                        - Harrow International School Hong Kong <br>
                        - International College Hong Kong & Hong Lok Yuen <br>
                        - Independent Schools Foundation Academy <br>
                        - Japanese International School <br>
                        - Korean International School <br>
                        ...
                        <div class="row s-countries">
                            <div class="col-xl-4 col-md-12">
                                <div class="outer-box mx-auto my-2">
                                    <div class="content-b-desc" style="background: url(https://itseducation.asia/school/img/school/JVdDqXbH5g0Xe04f-primary.webp); background-size: cover; background-position: center center;" alt="Invictus School - Chai Wan Campus">
                                        <div class="content-wrap">
                                            <div class="sub-content-wrap">
                                                <p class="text-center m-1"><a href="{{ $urlBase }}school-profile/Invictus+School+-+Chai+Wan+Campus" class="btn btn-primary s-btn">Invictus School - Chai Wan Campus</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@section('local-assets')
    ...
    <link rel="canonical" href="https://itseducation.asia/school/hong-kong/edb-schools-hk" />
