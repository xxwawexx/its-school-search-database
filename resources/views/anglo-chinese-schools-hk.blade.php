...
@section('content')
    ...
    <section class="container-fluid" id="skl-div">
        <div id="h-div" class="position-absolute text-light font-weight-bolder text-right">
            <header>
                <h1>
                    <span class="h1_titles">Anglo Chinese International Schools in Hong Kong</span><br>
                </h1>
            </header>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12 align-self-center order-1">
                        <ul class="breadcrumb d-block">
                            ...
                            <li class="active">Anglo Chinese International Schools in Hong Kong</li>
                        </ul>
                    </div>
                </div>
            </div>
...
@section('local-assets')
    ...
    <link rel="canonical" href="https://itseducation.asia/school/hong-kong/international-schools-hk/anglo-chinese-schools-hk" />
