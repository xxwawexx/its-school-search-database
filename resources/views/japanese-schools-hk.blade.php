...
@section('content')
    ...
    <section class="container-fluid" id="skl-div">
        <div id="h-div" class="position-absolute text-light font-weight-bolder text-right">
            <header>
                <h1>
                    <span class="h1_titles">Finding the Best Japanese International Schools in Hong Kong</span><br>
                </h1>
            </header>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12 align-self-center order-1">
                        <ul class="breadcrumb d-block">
                            <li>
                            @if( url()->current() == "https://school.itseducation.asia/hong-kong/international-schools-hk/japanese-schools-hk")
                            ...
                            <li class="active">Japanese International Schools in Hong Kong</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <section>
        <div class="container container-lg py-5">
            <div class="row">
                <div class="col-lg-9">
                    <p>
                        Did you know that the Japanese education system is renowned for being one of the best in the world? In Hong Kong, it is common for Japanese-speaking families to attend the Japanese International School HK, but others choose to embrace Japanese education and attend the Japanese school. If you want to enrol your child in an international school in Hong Kong, there is only one option. Hong Kong has a wide variety of international schools, but catering to just Japanese families is low in the education system. Still keen to learn about these schools? Read on to discover how your child can learn Japanese and embrace their culture.
                    </p>

                    <h2>
                        List of Top Japanese International Schools in Hong Kong
                    </h2>
                                    ...
                                    <div class="content-b-desc" style="background: url(https://itseducation.asia/school/img/school/japanese-intl-schl-ssd-pr.jpg); background-size: cover; background-position: center center;" alt="Japanese International School">
                                        <div class="content-wrap">
                                            ...
                                            @if( url()->current() == "https://school.itseducation.asia/hong-kong/igcse-schools-hk")
                                                <p class="text-center m-1"><a href="https://school.itseducation.asia/hong-kong/international-schools-hk/japanese-schools-hk" class="btn btn-primary s-btn">Japanese International School</a></p>
                                            @else
                                                <p class="text-center m-1"><a href="https://itseducation.asia/school/hong-kong/international-schools-hk/japanese-schools-hk" class="btn btn-primary s-btn">Japanese International School</a></p>
                                            @endif
                                            </div>
                                        </div>
                                    </div>
