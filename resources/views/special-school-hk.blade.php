...
@section('content')
    ...
    <section class="container-fluid" id="skl-div">
        <div id="h-div" class="position-absolute text-light font-weight-bolder text-right">
            <header>
                <h1>
                    <span class="h1_titles">Finding the Best Special Needs School in Hong Kong</span><br>
                </h1>
            </header>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12 align-self-center order-1">
                        <ul class="breadcrumb d-block">
                            <li>
                            @if( url()->current() == "https://school.itseducation.asia/hong-kong/special-school-hk")
                            ...
                            <li class="active">Special School in Hong Kong</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container container-lg py-5">
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <p>
                        The Special Needs Education at International school are as follows: <br>
                        - Australian International School (AISHK) – This is an inclusive school. Their Learning Enrichment team collaborates with teachers across all grades. There is a part-time speech therapist and pathologist on-site. <br>
                        - Discovery Bay International School – This inclusive school provides Occupational and Speech and Language Therapy Services. <br>
                        - ESF (English Schools Foundation) – Students are provided with Mainstream Placement with additional support. Or the Jockey Club Sarah Roe School, where students who require extensive support can be supported. <br>
                        - Hong Kong Academy (HKA) – This school offers curriculum interventions delivered by educational specialists within eight tiers. From neurotypical students without specified support (Tier 1) to students who need more directed help (Tier 8). <br>
                        - International College Hong Lok Yuen – This is an inclusive school. Two specialist teachers work in close liaison with classroom teachers to support children with educational or English language needs. <br>
                        - The International Christian School – This school supports mild to moderate learning needs in their bridging program, Bridges. <br>
                    ...
                    <h2>Criteria for Choosing a Special Needs School in Hong Kong</h2>
                    ...
                    <p>
                        ...
                        <a href="https://itseducation.asia/">www.itseducation.asia</a>
                    </p>
                    ...
                    <section>
                        <div class="row s-countries">
                            ...
                            <div class="col-xl-4 col-md-12">
                                <div class="outer-box mx-auto my-2">
                                    <div class="content-b-desc" style="background: url(https://itseducation.asia/school/img/school/KClegR11LpyWxyQF-primary.jpg); background-size: cover; background-position: center center;" alt="The Harbour School - Preparatory ">
                                        <div class="content-wrap">
                                            <div class="sub-content-wrap">
                                            @if( url()->current() == "https://school.itseducation.asia/hong-kong/special-school-hk")
                                                <p class="text-center m-1"><a href="https://school.itseducation.asia/school-profile/The+Harbour+School+-+Preparatory" class="btn btn-primary s-btn">The Harbour School - Preparatory </a></p>
                                            @else
                                                <p class="text-center m-1"><a href="https://itseducation.asia/school/school-profile/The+Harbour+School+-+Preparatory" class="btn btn-primary s-btn">The Harbour School - Preparatory </a></p>
                                            @endif
                                            </div>
                                        </div>
                                    </div>
...
@section('local-assets')
    ...
    <link rel="canonical" href="https://itseducation.asia/school/hong-kong/special-school-hk" />
