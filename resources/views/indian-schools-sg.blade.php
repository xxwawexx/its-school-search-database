...
@section('content')
    ...
    <section class="container-fluid" id="skl-div">
        <div id="h-div" class="position-absolute text-light font-weight-bolder text-right">
            <header>
                <h1>
                    <span class="h1_titles">Indian International Schools in Singapore</span><br>
                </h1>
            </header>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12 align-self-center order-1">
                        <ul class="breadcrumb d-block">
                            <li>
                            @if( url()->current() == "https://school.itseducation.asia/singapore/international-schools-sg/indian-schools-sg")
                            ...
                            <li class="active">Indian International Schools in Singapore</li>
                        </ul>
                    </div>
                </div>
            </div>
...
@section('local-assets')
    ...
    <link rel="canonical" href="https://itseducation.asia/school/singapore/international-schools-sg/indian-schools-sg" />
